...
class Audio_FSK_RX(gr.top_block, Qt.QWidget):

    def __init__(self, f0=8, f1=9):
        gr.top_block.__init__(self, "Audio_fsk_rx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Audio_fsk_rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Audio_FSK_RX")
        ...
        self.network_udp_source_0 = network.udp_source(gr.sizeof_float, 1, 5556, 0, 1472, False, False, False)
        ...
        self.blocks_threshold_ff_0 = blocks.threshold_ff(7, 8, 0)
        self.blocks_pack_k_bits_bb_0 = blocks.pack_k_bits_bb(8)
        self.blocks_float_to_char_0 = blocks.float_to_char(1, 1)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_char*1, 6)
        ...
        self.connect((self.blocks_char_to_float_1, 0), (self.audio_sink_0, 0))
        ...
        self.connect((self.blocks_float_to_char_0, 0), (self.blocks_delay_0_0, 0))
        ...
        self.connect((self.network_udp_source_0, 0), (self.blocks_add_xx_0, 0))
...
def main(top_block_cls=Audio_FSK_RX, options=None):
    if options is None:
