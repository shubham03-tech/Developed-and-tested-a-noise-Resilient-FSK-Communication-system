...
class video_with_fsk_transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "video_with_fsk_transmitter")
        ...
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:5566', 100, False, (-1), '', True, True)
...
def main(top_block_cls=video_with_fsk_transmitter, options=None):
