...
class Audio_FSK_TX(gr.top_block, Qt.QWidget):

    def __init__(self, f0=8, f1=9):
        gr.top_block.__init__(self, "Audio_Fsk_tx", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Audio_Fsk_tx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Audio_FSK_TX")
        ...
        self.network_udp_sink_0 = network.udp_sink(gr.sizeof_float, 1, '10.96.2.180', 50001, 0, 1472, False)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f(np.cos(2*np.pi*np.arange(0,9)/9), True, 1, [])
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.network_udp_sink_0, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.blocks_multiply_xx_0, 1))
...
def main(top_block_cls=Audio_FSK_TX, options=None):
    if options is None:
